...
experiments(end+1) = define_experiment(...
    ...
    'O-\alpha\gamma basic', @() vicos.descriptor.AlphaGamma(def_o_ag_basic{:}), ...
    'O-\alpha\gamma32', @() vicos.descriptor.AlphaGamma(def_o_ag_13x2_9{:}), ...
    'O-\alpha\gamma60', @() vicos.descriptor.AlphaGamma(def_o_ag_23x2_10{:}), ...
    'SO-\alpha\gamma32', @() vicos.descriptor.AlphaGamma(def_so_ag_13x2_9{:}, 'base_keypoint_size', 18.5), ...
    'SO-\alpha\gamma60', @() vicos.descriptor.AlphaGamma(def_so_ag_23x2_10{:}, 'base_keypoint_size', 18.5) ...
    );
...
experiments(end+1) = define_experiment(...
    ...
    'O-\alpha\gamma32', @() vicos.descriptor.AlphaGamma(def_o_ag_13x2_9{:}), ...
    'O-\alpha\gamma60', @() vicos.descriptor.AlphaGamma(def_o_ag_23x2_10{:}), ...
    'SO-\alpha\gamma32', @() vicos.descriptor.AlphaGamma(def_so_ag_13x2_9{:}, 'base_keypoint_size', 3.25), ...
    'SO-\alpha\gamma60', @() vicos.descriptor.AlphaGamma(def_so_ag_23x2_10{:}, 'base_keypoint_size', 3.25) ...
    );
...
experiments(end+1) = define_experiment(...
    ...
    'O-\alpha\gamma32', @() vicos.descriptor.AlphaGamma(def_o_ag_13x2_9{:}), ...
    'O-\alpha\gamma60', @() vicos.descriptor.AlphaGamma(def_o_ag_23x2_10{:}), ...
    'SO-\alpha\gamma32', @() vicos.descriptor.AlphaGamma(def_so_ag_13x2_9{:}, 'base_keypoint_size', 6.5), ...
    'SO-\alpha\gamma60', @() vicos.descriptor.AlphaGamma(def_so_ag_23x2_10{:}, 'base_keypoint_size', 6.5) ...
    );
...
experiments(end+1) = define_experiment(...
    ...
    'U-LATCH64', @() vicos.descriptor.LATCH(def_u_latch64{:}), ...
    'U-FREAK', @() vicos.descriptor.FREAK(def_u_freak{:}), ...
    'SU-FREAK', @() vicos.descriptor.FREAK(def_su_freak{:}), ... % It seems 'PatternScale' 45 (what we used above) worsens results here
    'U-\alpha\gamma32', @() vicos.descriptor.AlphaGamma(def_u_ag_13x2_9{:}), ...
    'U-\alpha\gamma60', @() vicos.descriptor.AlphaGamma(def_u_ag_23x2_10{:}), ...
    'SU-\alpha\gamma32', @() vicos.descriptor.AlphaGamma(def_su_ag_13x2_9{:}, 'base_keypoint_size', 3.25), ...
    'SU-\alpha\gamma60', @() vicos.descriptor.AlphaGamma(def_su_ag_23x2_10{:}, 'base_keypoint_size', 3.25) ...
...
experiments(end+1) = define_experiment(...
    ...
    'U-LATCH64', @() vicos.descriptor.LATCH(def_u_latch64{:}), ...
    'U-FREAK', @() vicos.descriptor.FREAK(def_u_freak{:}), ...
    'SU-FREAK', @() vicos.descriptor.FREAK(def_su_freak{:}), ...
    'U-\alpha\gamma32', @() vicos.descriptor.AlphaGamma(def_u_ag_13x2_9{:}), ...
    'U-\alpha\gamma60', @() vicos.descriptor.AlphaGamma(def_u_ag_23x2_10{:}), ...
    'SU-\alpha\gamma32', @() vicos.descriptor.AlphaGamma(def_su_ag_13x2_9{:}, 'base_keypoint_size', 18.5), ...
    'SU-\alpha\gamma60', @() vicos.descriptor.AlphaGamma(def_su_ag_23x2_10{:}, 'base_keypoint_size', 18.5) ...
...
experiments(end+1) = define_experiment(...
    ...
    'SURF keypoints (unoriented)', ...
    @() vicos.keypoint_detector.SURF('HessianThreshold', 400, 'NOctaves', 3, 'NOctaveLayers', 4, 'UpRight', true), ...
    'U-\alpha\gamma32-full', @() vicos.descriptor.AlphaGamma(def_u_ag_13x2_9{:}), ...
    'U-\alpha\gamma60-type1', @() vicos.descriptor.AlphaGamma(def_u_ag_23x2_10{:}, 'compute_base', true, 'compute_extended', false), ...
    'U-\alpha\gamma60-type2', @() vicos.descriptor.AlphaGamma(def_u_ag_23x2_10{:}, 'compute_base', false, 'compute_extended', true), ...
    'U-\alpha\gamma60-full', @() vicos.descriptor.AlphaGamma(def_u_ag_23x2_10{:}) ...
    );
