...
def_u_ag_basic = { 'orientation', false, 'num_rays', 41, 'num_circles', 12, 'compute_type2', false, 'sampling', 'simple', 'use_scale', false, 'base_sigma', sqrt(2) };
def_o_ag_basic = { 'orientation', true,  'num_rays', 41, 'num_circles', 12, 'compute_type2', false, 'sampling', 'simple', 'use_scale', false, 'base_sigma', sqrt(2) };
...
experiments(end+1) = define_experiment(...
    ...
    'SU-AG60', @() vicos.descriptor.AlphaGamma(def_su_ag_23x2_10{:}, 'base_keypoint_size', base_keypoint_size) ...
    );

basic_keypoint_size = 3.25; % SIFT
experiments(end+1) = define_experiment(...
    'u-sift', ...
...
experiments(end+1) = define_experiment(...
    ...
    'SO-AG60', @() vicos.descriptor.AlphaGamma(def_so_ag_23x2_10{:}, 'base_keypoint_size', base_keypoint_size) ...
    );

base_keypoint_size = 3.25; % SIFT
experiments(end+1) = define_experiment(...
    'sift', ...
...
sequences = { 'trees', 'ubc', 'leuven', 'bikes' };
...
experiments(end+1) = define_experiment(...
    ...
    'U-AG60-type1', @() vicos.descriptor.AlphaGamma(def_u_ag_23x2_10{:}, 'compute_type1', true, 'compute_type2', false), ...
    'U-AG60-type2', @() vicos.descriptor.AlphaGamma(def_u_ag_23x2_10{:}, 'compute_type1', false, 'compute_type2', true), ...
