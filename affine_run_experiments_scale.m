% AFFINE_RUN_EXPERIMENTS_SCALE
%
% Runs all scale experiments on Affine Dataset sequences.
%
...
visualize = false;
result_dir = 'results-affine-scale';

sequences = { 'wall', 'graffiti' };
image = 1;
scales = 1.00:0.05:1.50;
...
for s = 1:numel(sequences),
    ...
    if ~exist(result_file, 'file'),
        ...
        results = affine_batch_experiment_scale(keypoint_detector, descriptors, 'sequence', sequence, 'image', image, 'scales', scales, 'project_keypoints', project_keypoints);
